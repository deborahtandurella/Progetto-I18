...
import gUIInteface.exception.NeedANumber;
...
public class NumberPhoneGUI extends JFrame {
    ...
    public NumberPhoneGUI() {
        ...
        this.setLayout(null);
        JLabel labelNumber = new JLabel(LABEL);
        labelNumber.setBounds(LABELNUMBERX1,LABELNUMBERY1,LABELNUMBERX2,LABELNUMBERY2);
