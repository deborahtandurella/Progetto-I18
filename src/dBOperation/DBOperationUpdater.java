...
import gUIInteface.exception.DBOperationEmpty;
import gUIInteface.exception.OperationAlreadyUsed;
import gUIInteface.exception.OperationNotFound;
...
public class DBOperationUpdater {
    ...
    public DBOperationUpdater() {
        operationReader = new DBOperationReader();
    }
    /**
