...
public class DBOperationDAO implements IDBOperationProxy {
    ...
    /**
     * This method is called to remove an operation in the storage unit at a defined number and id
     * @param numCalling
     * @param id
     * @param number
     */
    ...
    /**
     * This method is called to change the id of an operation in the storage unit at a defined number and old id
     * @param numCalling
     * @param oldID
     * @param number
     * @param newID
    ...
    /**
     * This method returns all the operations having a defined id and number
     * @param numCalling
     * @param numCall
    ...
    public ArrayList<Operation> getAvailableOptionToShow(String numCalling, String numCall, String numberSequence) {
        connection = connectionManager.connectToDB(connection);
        ArrayList<Operation> options = operationReader.retrieveTheAvailableOption(connection, numCalling, numCall, numberSequence);
        connection = connectionManager.disconnectFromDB(connection);
        return options;
    }
}
